...
# Form implementation generated from reading ui file 'simplecalcuv3.ui'
#
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(30, 270, 161, 51))
        font = QtGui.QFont()
        ...
        self.label_4.setGeometry(QtCore.QRect(40, 350, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.label_3.setGeometry(QtCore.QRect(100, 410, 271, 61))
        font = QtGui.QFont()
        ...
        self.pushButton.setGeometry(QtCore.QRect(400, 290, 93, 71))
        self.pushButton.setStyleSheet("border-radius : 100; border : 2px solid black\n"
"setGeometry(200, 150, 100, 100)")
        self.pushButton.setObjectName("pushButton")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(200, 270, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lineEdit.setFont(font)
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_2.setGeometry(QtCore.QRect(200, 340, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        def Calcu():
            ...
            try:
                ...
                ans = (num2str*num1str)
                print(ans)
                self.label_3.setText(str("{0:.2f}".format(ans)))
...
"╚█████╔╝██║░░██║███████╗╚█████╔╝╚██████╔╝\n"
"░╚════╝░╚═╝░░╚═╝╚══════╝░╚════╝░░╚═════╝░"))
        self.label_2.setText(_translate("MainWindow", "Value Per (mm)"))
        self.label_4.setText(_translate("MainWindow", "Length (mm)"))
